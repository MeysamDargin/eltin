...
class _MetalsScreenState extends State<MetalsScreen> {
  ...
  // Map of metals keys to Persian names
  final Map<String, String> _metalsMap = {
    'base_global_copper': 'مس بازار لندن',
    'base-us-copper': 'مس بازار آمریکا (COMEX)',
    'base-us-aluminum': 'آلومینیوم',
    'base_global_lead': 'سرب',
    'base_global_zinc': 'روی',
    'base_global_nickel': 'نیکل',
    'cobalt': 'کبالت',
    'base_global_tin': 'قلع',
    'base-us-steel-coil': 'فولاد',
  };
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => MarketDetailScreen(
                      ...
                      isRial: false,
                      iconPath: 'assets/icons/gold-ingot.png',
                    ),
                  ),
                );
              },
              child: _buildMetalCard(data['name'], data['item']),
            );
          },
        );
      },
  ...
  Widget _buildMetalCard(String name, dynamic item) {
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/icons/gold-ingot.png', // Generic metal icon
                    width: 24,
                    color: const Color.fromARGB(255, 60, 85, 88),
                  ),
                ),
