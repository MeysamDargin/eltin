...
class _CommoditiesScreenState extends State<CommoditiesScreen> {
  ...
  // Map of commodities keys to Persian names
  final Map<String, String> _commoditiesMap = {
    'commodity_us_wheat': 'گندم آمریکا',
    'commodity_us_corn': 'ذرت آمریکا',
    'commodity_us_soybeans': 'سویا',
    'commodity_us_sugar_no11': 'شکر',
    'commodity_us_cotton_no_2': 'پنبه',
    'commodity_us_coffee_c': 'قهوه',
    'commodity_us_cocoa': 'کاکائو',
    'commodity_rough_rice': 'برنج خام',
  };

  final Map<String, String> _commodityIconMap = {
    'commodity_us_wheat': 'wheat-sack.png',
    'commodity_us_corn': 'corn.png',
    'commodity_us_soybeans': 'soybean.png',
    'commodity_us_sugar_no11': 'sugar.png',
    'commodity_us_cotton_no_2': 'cotton.png',
    'commodity_us_coffee_c': 'coffee-bag.png',
    'commodity_us_cocoa': 'cocoa.png',
    'commodity_rough_rice': 'rice.png',
  };
  ...
  Widget _buildCurrencyList() {
    return Consumer<PriceProvider>(
      builder: (context, provider, child) {
        ...
        _commoditiesMap.forEach((key, name) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final iconName =
                _commodityIconMap[data['key']] ??
                'grocery-store-groceries-svgrepo-com.png';
  ...
  Widget _buildCommodityCard(String key, String name, dynamic item) {
    ...
    String iconName =
        _commodityIconMap[key] ?? 'grocery-store-groceries-svgrepo-com.png';
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Image.asset('assets/icons/$iconName', width: 24),
                ),
              ),
            ],
          ),
